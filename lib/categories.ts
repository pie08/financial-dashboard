...
export const CATEGORIES: { name: string; kind: CategoryKind }[] = [
  ...
  { name: "Payroll Expenses", kind: "expense" },
...
const STRUCTURAL_RULES: {
  ...
  {
    pattern: /mobile check deposit|check deposit|remote deposit/i,
  ...
  {
    pattern: /zelle|cash app|square inc|sq \*|stripe/i,
    credit: true,
    category: "Customer Payments",
  },
];
...
const BANK_CATEGORY_MAP: [RegExp, string][] = [
  ...
  [/^gas$|fuel/i, "Fuel & Gas"],
  [
    /fast food|restaurant|coffee|food and drink|beer|wine|liquor|alcohol/i,
    "Meals & Dining",
  ],
  ...
  [
    /automotive|auto parts|car wash|oil change|vehicle/i,
    "Vehicle & Maintenance",
  ],
  [/insurance/i, "Insurance"],
  [
    /software|web services|music and audio|tv and movies|streaming/i,
    "Software & Subscriptions",
  ],
  [/advertising|marketing/i, "Marketing"],
  [
    /clothing|department store|superstore|discount store|general merchandise|electronics|eye care/i,
    "Shopping",
  ],
  [
    /entertainment|video games|sporting events|amusement|museums/i,
    "Entertainment",
  ],
  [
    /pharmac|health|medical|dental|supplements|gyms and fitness/i,
    "Health & Fitness",
  ],
...
const KEYWORD_RULES: [RegExp, string][] = [
  [
    /shell|exxon|mobil|citgo|sunoco|gulf oil|chevron|bp\b|speedway|nouria|irving|circle k|cumberland|gas/i,
    "Fuel & Gas",
  ],
  [
    /chemical|detail supply|meguiar|adam'?s polish|griot|autogeek|car wash|chemguy|armor all|turtle wax/i,
    "Supplies & Chemicals",
  ],
  [
    /home depot|lowe'?s|harbor freight|ace hardware|northern tool/i,
    "Equipment & Tools",
  ],
  [
    /autozone|o'?reilly|napa|advance auto|jiffy lube|valvoline|firestone|midas|tire/i,
    "Vehicle & Maintenance",
  ],
  [
    /insurance|geico|progressive|allstate|state farm|next insurance|hiscox/i,
    "Insurance",
  ],
  [
    /vercel|adobe|google|spotify|tidal|soundcloud|netflix|apple\.com|microsoft|dropbox|canva|quickbooks|paddle|subscription|rekordbox/i,
    "Software & Subscriptions",
  ],
  [
    /facebook|facebk|meta ads|google ads|yelp|vistaprint|thumbtack|angi\b/i,
    "Marketing",
  ],
  [
    /mcdonald|wendy|burger|taco|chipotle|chick-?fil|kfc|dunkin|starbucks|pizza|deli|restaurant|grill|cafe|diner|subs|five guys|dairy queen|raising cane|panera|doordash|grubhub|uber\s*eats|dave'?s hot/i,
    "Meals & Dining",
  ],
  [
    /market basket|hannaford|shaw'?s|walmart|wal-mart|target|costco|grocer|supermarket|aldi|kroger/i,
    "Groceries",
  ],
  [
    /burlington|marshalls|tj\s*maxx|old navy|american eagle|calvin klein|nike|adidas|amazon|ebay|dollar general|clothing|factory store|sunglass/i,
    "Shopping",
  ],
  [
    /cinema|regal|amc\b|theat|steam|playstation|xbox|nintendo|billiards|bowling|golf|park/i,
    "Entertainment",
  ],
  [
    /cvs|walgreens|rite aid|pharmacy|planet fitness|gym|fitness/i,
    "Health & Fitness",
  ],
  ...
  [
    /overdraft fee|service charge|monthly fee|atm fee|wire fee/i,
    "Fees & Charges",
  ],
];
